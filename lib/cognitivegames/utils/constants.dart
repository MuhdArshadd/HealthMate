...
const List<Map<String, dynamic>> gameLevels = [
  {'title': '4 x 4', 'level': 4, 'color': Colors.green},
  {'title': '6 x 6', 'level': 6, 'color': Colors.blueAccent},
  {'title': '8 x 8', 'level': 8, 'color': Colors.red},
];

const String gameTitle = 'MEMORY MATCH GAME';
const String gamePrompt = 'Choose a game mode to begin:';